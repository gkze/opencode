...
| `catppuccin-latte`     | Light [Catppuccin](https://github.com/catppuccin) flavor                     |
| `catppuccin-frappe`    | Dark [Catppuccin](https://github.com/catppuccin) flavor                      |
| `catppuccin-mocha`     | Dark [Catppuccin](https://github.com/catppuccin) flavor                      |
